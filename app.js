...
function render() {
    ...
    for (var i = 0; i < 10; i++) {
        ...
        str += `<div data-num="${i}" class="result">
                    <img src="${arrB[i].Picture1}" alt="">
                    <div class="content">
                        <h3>${arrB[i].Name}</h3>
                        <span>${arrB[i].Ticketinfo}</span>
...
function xhrListener() {
    ...
    for (var count = 0; count < 10; count++) {
        str +=
            `<div data-num="${i}" class="result">
                <img src="${arrA[count].Picture1}" alt="">
                <div class="content">
                    <h3>${arrA[count].Name}</h3>
                    <span>${arrA[count].Ticketinfo}</span>
...
function changePage() {
    ...
    for (var i = active.dataset.num * 10; i < (active.dataset.num * 10) + 10; i++) {
        if (arrA[i] == undefined || arrB[i] == undefined) {
            return;
